...
namespace fx.Localization
{
	...
	/// <summary>
	/// Extension for <see cref="fxLocalizedStrings"/>.
	/// </summary>
	public static class LocalizedStringsExtension
	{
		...
		{
			var asmHolder = typeof(fxLocalizedStrings).Assembly;
	...
	/// Localized strings.
	/// </summary>
	public static partial class fxLocalizedStrings
	{
		static fxLocalizedStrings()
		{
			try
			{
