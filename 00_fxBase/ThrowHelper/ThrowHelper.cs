...
namespace fx.Base
{
    public static class ThrowHelper
    {
        ...
        public static void ThrowCapacityArgumentOutOfRangeException()
        {
            throw new ArgumentOutOfRangeException( "capacity" );
        }

        [MethodImpl( MethodImplOptions.NoInlining )]
        public static void ThrowKeyArgumentNullException()
        {
        ...
        public static void ThrowArgumentNullException( ExceptionResource resource )
        ...
        public static void ThrowArgumentOutOfRangeException( ExceptionArgument argument, int paramNumber, ExceptionResource resource )
        ...
        private static string GetArgumentName( ExceptionArgument argument )
        {
            switch ( argument )
            {
                ...
                case ExceptionArgument.start:
                    return "start";
                case ExceptionArgument.Myformat:
                    return "format";
